import Danial from '../../assets/image-daniel.jpg'
...
const CardData =  [
  {
    ...
    "info": "I received a job offer mid-course, and the subjects I learned were current, if not more so,\nin the company I joined. I honestly feel I got every penny’s worth.",
    ...
    "image": Danial
      ...
      },
      {
        "name": "Patrick Abrams",
        "position": "Verified Graduate",
        "info": "Awesome teaching support from TAs who did the bootcamp themselves. Getting guidance from them and\n" +
